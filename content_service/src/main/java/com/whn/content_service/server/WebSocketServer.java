package com.whn.content_service.server;
...
import com.whn.content_service.service.impl.NoticeServiceImpl;
...
public class WebSocketServer {
    ...
    public String adminId="79c308ea630d4e6f8d647e8278962bea";
    ...
    public void onOpen(Session session, @PathParam("userId") String userId) {
        ...
        List<Notice> noReceiveNoticeByUserId = noticeService.findNoReceiveNoticeByReceiveUserId(userId);
        if (noReceiveNoticeByUserId.size() > 0) {
            noReceiveNoticeByUserId.forEach(notice -> {
                notice.setStatus("true");
                noticeService.updateById(notice);
                sendMessage(notice.getReceiveUserId(), notice.getContent(), session);
